...
#monitor
import wandb
wandb.init(project="visionnerf02")
        ...
        for train_data in train_loader:
            ...
            if args.local_rank == 0:
                if global_step % args.i_print == 0 or global_step < 10:
                    ...
                    wandb.log({"train/coarse-loss":scalars_to_log['train/coarse-loss'],
		               "train/coarse-psnr-training-batch" : scalars_to_log['train/coarse-psnr-training-batch'],
                               "train/fine-loss" : scalars_to_log['train/fine-loss'],
                             "train/fine-psnr-training-batch": scalars_to_log['train/fine-psnr-training-batch']})
